...
void addGlyphQuad(sf::VertexArray &vertices, sf::Vector2f position,
                  const sf::Color &color, const sf::Glyph &glyph, float italic,
                  float outlineThickness = 0) {
...
////////////////////////////////////////////////////////////
FText::FText()
    : m_string(), m_font(NULL), m_characterSize(30), m_style(Regular),
...
FText::FText(const String &string, const Font &font, unsigned int characterSize)
    : m_string(string), m_font(&font), m_characterSize(characterSize),
      m_style(Regular), m_fillColor(255, 255, 255), m_outlineColor(0, 0, 0),
      m_outlineThickness(0), m_vertices(Triangles),
...
////////////////////////////////////////////////////////////
void FText::setColor(const Color &color) { setFillColor(color); }
...
////////////////////////////////////////////////////////////
const String &FText::getString() { return m_string; }

////////////////////////////////////////////////////////////
const Font *FText::getFont() { return m_font; }

////////////////////////////////////////////////////////////
unsigned int FText::getCharacterSize() { return m_characterSize; }

////////////////////////////////////////////////////////////
Uint32 FText::getStyle() { return m_style; }

////////////////////////////////////////////////////////////
const Color &FText::getColor() { return getFillColor(); }

////////////////////////////////////////////////////////////
const Color &FText::getFillColor() { return m_fillColor; }

////////////////////////////////////////////////////////////
const Color &FText::getOutlineColor() { return m_outlineColor; }

////////////////////////////////////////////////////////////
float FText::getOutlineThickness() { return m_outlineThickness; }
...
void FText::ensureGeometryUpdate() const {
    ...
    for (std::size_t i = 0; i < m_string.getSize(); ++i) {
        ...
        // Apply the outline
        if (m_outlineThickness != 0) {
            const Glyph &glyph = m_font->getGlyph(curChar, m_characterSize,
                                                  bold, m_outlineThickness);
            ...
            addGlyphQuad(m_outlineVertices, Vector2f(x, y), m_outlineColor,
                         glyph, italic, m_outlineThickness);

            // Update the current bounds with the outlined glyph bounds
            minX =
                std::min(minX, x + left - italic * bottom - m_outlineThickness);
            maxX =
                std::max(maxX, x + right - italic * top - m_outlineThickness);
    ...
    if (strikeThrough && (x > 0)) {
        addLine(m_vertices, x, y, fcolor, strikeThroughOffset,
                underlineThickness);
...
sf::Color FText::getColorForChar(char c) {
    ...
    case '1':
        return sf::Color(168, 252, 186); // cyan
    case '2':
        return sf::Color(235, 78, 247);  // violet
    case '3':
        return sf::Color(115, 236, 238); // blue
    default:
        return sf::Color::White;
    }
}
